...
const routes = [
  ...
  { path: '/seat-issues', component: () => import('./views/SeatIssueView.vue'), meta: { roles: ['staff', 'volunteer', 'admin', 'security'] } },
  { path: '/maintenance', component: () => import('./views/MaintenanceView.vue'), meta: { roles: ['staff', 'admin'] } },
